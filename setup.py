...
setup(name=PACKAGE_NAME,
      ...
      entry_points ={'console_scripts': [ 'top2phase = Top2Phase.main:main','orderparms= Top2Phase.compute_orderparameters:main', 'pwdist=Top2Phase.compute_pairwisedistance:main'  ]},
      python_requires='>3.5',
      )
